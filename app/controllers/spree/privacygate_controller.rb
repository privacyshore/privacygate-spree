require 'privacygate'
module Spree
  class PrivacyGateController < StoreController
    ...
    def notify
      ...
      begin
        payment = Spree::PaymentMethod.find_by(type: "Spree::PaymentMethod::PrivacyGatePayment")
        ...
        return
      rescue PrivacyGate::Errors::SignatureVerificationError
        head :uprocessable_entity
        return
      rescue PrivacyGate::Errors::WebhookInvalidPayload
        head :uprocessable_entity
        return
      end
    end
